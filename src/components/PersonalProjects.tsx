...
function PersonalProjects() {
    ...
    <div className="fun-container" id="personal_projects">
        ...
        <div className="fun-grid">
            <div className="fun">
                <a href="https://github.com/sofiakwok/link_tracker" target="_blank" rel="noreferrer"><img src={opi} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="fun">
                <a href="https://www.xbotrobotics.org/" target="_blank" rel="noreferrer"><img src={xbot} className="zoom" alt="thumbnail" width="100%"/></a>
